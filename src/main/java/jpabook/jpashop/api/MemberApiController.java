...
public class MemberApiController {
    ...
    public UpdateMemberResponse updateMemberV2(@PathVariable("id") Long id,
        ...
        Member findMember = memberService.findOne(id); // select query가 발생되지 않는다.
        /*findMember.setName("testName");
        memberService.testMethod(); 이 두 개의 line을 실행하면 최종적으로 이름이 testName으로 변경된다. */
